...
from model_hu_s3_new_Dy_lr import embed_net
from utils import *
...
parser.add_argument('--model_path', default='/DATA/fengmengya/save_model/sysu_hu_s3_new_Dy_lr/', type=str, 
