...
from model_hu_s3_s4_use_s3_new_Dy_lr import embed_net
from utils import *
...
parser.add_argument('--model_path', default='/DATA/fengmengya/save_model/sysu_hu_s3_s4_use_s3_new_Dy_lr/', type=str, 
                    help='model save path')
parser.add_argument('--save_epoch', default=20, type=int,
                    metavar='s', help='save model every 10 epochs')
parser.add_argument('--log_path', default='log_s4_use_s3/', type=str, 
                    help='log save path')
...
print('..........sysu_hu_s3_s4_use_s3_new_Dy_lr....................')
print('==> Loading data..')
# Data loading code
...
ignored_params = list(map(id, net.feature1.parameters())) \
                 ...
                 + list(map(id, net.layer4_r.visible.layer4.parameters())) \
                 + list(map(id, net.layer4_i.thermal.layer4.parameters())) \
...
if args.optim == 'sgd':
    optimizer = optim.SGD([
         ...
         {'params': net.layer4_r.visible.layer4.parameters(), 'lr': args.lr},
         {'params': net.layer4_i.thermal.layer4.parameters(), 'lr': args.lr},
