...
class ConvDY2d(nn.Module):
    ...
    """
    def __init__(self, in_channels, out_channels, kernel_size=3, stride=1, padding=0, dilation=1, groups=1, bias=True, dynamic_number = 4, delta = 30):
    ...
    def forward(self, x,y):
        ...
        pdb.set_trace()
        softmax_weights = self.attention_module(y)
