...
from model_LWPA_Dy_uploss import embed_net
from utils import *
...
parser.add_argument('--model_path', default='/home/panpeng/fmy/save_model/base_ye/LWPA_Dy_uploss/', type=str, 
