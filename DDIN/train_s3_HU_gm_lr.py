...
from model_s3_HU_gm_lr import embed_net
from utils import *
...
parser.add_argument('--model_path', default='/DATA/fengmengya/save_model/Dynamic_s3_HU_gm_lr_gm=on/', type=str, 
...
print('..........Dynamic_s3_HU_gm_lr_gm=on......................')
print('==> Loading data..')
# Data loading code
