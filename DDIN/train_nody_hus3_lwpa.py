...
from model_nody_hus3_lwpa import embed_net
from utils import *
...
parser.add_argument('--model_path', default='/DATA/fengmengya/save_model/nody_hus3_lwpa/', type=str, 
