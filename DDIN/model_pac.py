...
from PacConv2d import PacConv2d
import pdb
...
class embed_net(nn.Module):
    def __init__(self, low_dim, class_num, drop = 0.5, arch ='resnet50'):
        ...
        self.PAC = PacConv2d(1024,1024,3)
    ...
    def forward(self, x1, x2, modal = 0 ):
        if modal==0:
            ...
            #PAC
            x1_s3 = self.PAC(x1_s3)
            
            
        elif modal ==1:
            x_s3,x = self.visible_net(x1)
            x = x.chunk(6,2)
