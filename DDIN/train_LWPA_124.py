...
from model_LWPA_124 import embed_net
from utils import *
...
parser.add_argument('--model_path', default='/DATA/linxianmin/fmy/save_model/sysu_LWPA_124_nolr/', type=str, 
