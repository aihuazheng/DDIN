...
parser.add_argument('--resume', '-r', default='Dynamic_s3sysu_id_bn_relu_drop_0.0_lr_1.0e-02_dim_512_whc_0.5_thd_0_pimg_8_ds_l2_md_all_resnet50_best.t', type=str, help='resume from checkpoint')
parser.add_argument('--model_path', default='/DATA/fengmengya/save_model/', type=str, help='model save path')
...
if dataset =='regdb':
    ...
    #cmc_pool = all_cmc_pool /100
    #mAP_pool = all_mAP_pool /100
    print ('All Average:')
