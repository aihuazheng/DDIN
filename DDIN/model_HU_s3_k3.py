...
class embed_net(nn.Module):
    def __init__(self, low_dim, class_num, drop = 0.5, arch ='resnet50'):
        ...
        self.conv_basis= ConvBasis2d(64,1024, 512, kernel_size=3, padding=0, bias=False)
        ...
        self.Conv3x3 = Conv3x3(1024,512)
        self.Conv3x3_i = Conv3x3(1024,512)
