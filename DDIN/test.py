...
parser.add_argument('--resume', '-r', default='sysu_id_bn_relu_drop_0.0_lr_1.0e-02_dim_512_whc_0.9_thd_0_pimg_8_ds_l2_md_all_resnet50_best.t', type=str, help='resume from checkpoint')
parser.add_argument('--model_path', default='/DATA/fengmengya/save_model/HC_0_9_nolr_100/', type=str, help='model save path')
...
#query_cam6_0028_0019 = query_s3[278:279,:,:,:]
#query_label_now = query_label[278]
#print(query_label_now)
#view_query_s3 = torch_vis_color('sysu_dy_cam6_0028_0019',query_cam6_0028_0019,32,32,'/DATA/fengmengya/save_image/baseline/',colormode=2,margining=1) 
all_cmc = 0
all_mAP = 0 
all_cmc_pool = 0
if dataset =='regdb':
