...
class embed_net(nn.Module):
    ...
    def forward(self, x1, x2, modal = 0 ):
        if modal==0:
            ...
            x3 = self.num_part(x1_s4)
            x4 = self.num_part(x2_s4)
        ...
        # x = self.dropout(x)
            ...
            x3 = x3.chunk(6, 2)
            x3_0 = x3[0].contiguous().view(x3[0].size(0), -1)
            x3_1 = x3[1].contiguous().view(x3[1].size(0), -1)
            x3_2 = x3[2].contiguous().view(x3[2].size(0), -1)
            x3_3 = x3[3].contiguous().view(x3[3].size(0), -1)
            x3_4 = x3[4].contiguous().view(x3[4].size(0), -1)
            x3_5 = x3[5].contiguous().view(x3[5].size(0), -1)
            
            x4 = x4.chunk(6, 2)
            x4_0 = x4[0].contiguous().view(x4[0].size(0), -1)
            x4_1 = x4[1].contiguous().view(x4[1].size(0), -1)
            x4_2 = x4[2].contiguous().view(x4[2].size(0), -1)
            x4_3 = x4[3].contiguous().view(x4[3].size(0), -1)
            x4_4 = x4[4].contiguous().view(x4[4].size(0), -1)
            x4_5 = x4[5].contiguous().view(x4[5].size(0), -1)
            
            x_0 = torch.cat((x1_0, x2_0,x3_0, x4_0), 0)
            x_1 = torch.cat((x1_1, x2_1,x3_1, x4_1), 0)
            x_2 = torch.cat((x1_2, x2_2,x3_2, x4_2), 0)
            x_3 = torch.cat((x1_3, x2_3,x3_3, x4_3), 0)
            x_4 = torch.cat((x1_4, x2_4,x3_4, x4_4), 0)
            x_5 = torch.cat((x1_5, x2_5,x3_4, x4_4), 0)
        elif modal ==1:
            #pdb.set_trace()
