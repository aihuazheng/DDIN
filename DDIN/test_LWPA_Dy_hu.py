...
from  model_LWPA_Dy_hu import embed_net
from utils import *
import time 
...
parser.add_argument('--model_path', default='/DATA/fengmengya/save_model/LWPA_Dy_HU/', type=str, help='model save path')
...
start_epoch = 0 
print('==> LWPA_Dy_2014_Hu_all_single')
...
query_v_387= query_att_s3[1670:1671,:,:]
query_label_now = query_label[1670]
#pdb.set_trace()
#print(query_cam6_0021_0001)
print(query_label_now)
#cv2.imwrite('/DATA/fengmengya/save_image/query_LWPA/'+'query_cam6_0021_0001'+'att_s3.jpg',query_cam6_0021_0001)
view_query_att_s3 = torch_vis_color('query_v_387_LWPA',query_v_387 ,32,32,'/DATA/fengmengya/save_image/regdb_LWPA_dy/',colormode=2,margining=1) 
'''
...
'''
query_s3_hu = torch.from_numpy(query_s3_hu)
query_cam6_0037_0018 = query_s3_hu[437:438,:,:,:]
query_label_now = query_label[437]
print(query_label_now)
view_query_s3_hu = torch_vis_color('cam6_0037_0018',query_cam6_0037_0018,32,32,'/DATA/fengmengya/save_image/LWPA_DY/',colormode=2,margining=1) 
'''
