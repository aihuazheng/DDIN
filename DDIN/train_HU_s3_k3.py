...
from model_HU_s3_k3 import embed_net
from utils import *
...
parser.add_argument('--model_path', default='/DATA/fengmengya/save_model/Dynamic_HU_s3_k3/', type=str, 
...
parser.add_argument('--gpu', default='2,3,4,5', type=str,
