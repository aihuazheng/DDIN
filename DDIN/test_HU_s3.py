...
from model_HU_s3_new import embed_net
from utils import *
import time 
...
parser.add_argument('--model_path', default='/DATA/fengmengya/save_model/HU_s3/', type=str, help='model save path')
...
def extract_query_feat(query_loader):
    ...
    return query_feat,query_s3_hu,query_label



#pdb.set_trace()    
query_feat,query_s3_hu,query_label = extract_query_feat(query_loader)    
query_s3_hu = torch.from_numpy(query_s3_hu)
query_cam6_0028_0018 = query_s3_hu[277:278,:,:,:]
query_label_now = query_label[277]
print(query_label_now)
view_query_s3_hu = torch_vis_color('sysu_dy_cam6_0028_0018_1',query_cam6_0028_0018,32,32,'/DATA/fengmengya/save_image/Dy/',colormode=2,margining=1) 
