...
parser.add_argument('--model_path', default='/DATA/fengmengya/save_model/sysu_indoor_s3_HU_lr/', type=str, 
                    help='model save path')
parser.add_argument('--save_epoch', default=20, type=int,
                    metavar='s', help='save model every 10 epochs')
parser.add_argument('--log_path', default='log_sysu/', type=str, 
                    help='log save path')
