...
from model_s4tos3_cx_allpool import embed_net
from utils import *
...
parser.add_argument('--model_path', default='/DATA/fengmengya/save_model/s4tos3_cx_allpool/', type=str, 
