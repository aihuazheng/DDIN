...
from model_HU_s3_s4_use_s3 import embed_net
from utils import *
...
parser.add_argument('--model_path', default='/DATA/fengmengya/save_model/sysu_HU_s3_s4_use_s3/', type=str, 
