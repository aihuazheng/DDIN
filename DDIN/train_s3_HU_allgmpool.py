...
from model_s3_HU_allgmpool import embed_net
from utils import *
...
parser.add_argument('--model_path', default='/DATA/fengmengya/save_model/s3_HU_allgmpool_allon/', type=str, 
