...
parser.add_argument('--model_path', default='/home/panpeng/fmy/save_model/base_ye/dy_nohu_lwpa/', type=str, 
...
def train(epoch, loss_log):
    ...
    for batch_idx, (input1, input2, label1, label2) in enumerate(trainloader):
        ...
        if args.method =='id':
            ...
            #loss_tri_s3 = criterion_tri(feat[8],labels)
        ...
        loss_s3 = (loss_id_s3+loss_tri_s3)/2
