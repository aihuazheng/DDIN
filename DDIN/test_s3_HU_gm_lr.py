...
from model_HU_s3  import embed_net
from utils import *
import time 
...
parser.add_argument('--model_path', default='/DATA/fengmengya/save_model/HU_s3_test_use_HE/', type=str, help='model save path')
