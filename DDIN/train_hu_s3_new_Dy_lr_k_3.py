...
from model_hu_s3_new_Dy_lr_k_3 import embed_net
from utils import *
...
parser.add_argument('--model_path', default='/DATA/fengmengya/save_model/sysu_hu_s3_new_Dy_lr_k_3/', type=str, 
                    help='model save path')
parser.add_argument('--save_epoch', default=20, type=int,
                    metavar='s', help='save model every 10 epochs')
parser.add_argument('--log_path', default='log_newDy/', type=str, 
                    help='log save path')
...
print('..........sysu_hu_s3_new_Dy_lr_k=3....................')
print('==> Loading data..')
# Data loading code
