...
parser.add_argument('--model_path', default='/DATA/fengmengya/save_model/sysu_hu_s3_new_Dy_lr/', type=str, help='model save path')
parser.add_argument('--log_path', default='log_newDy/', type=str, help='log save path')
