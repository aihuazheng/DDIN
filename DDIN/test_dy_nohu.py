...
from model_Dy_nohu_no_LWPA  import embed_net
from utils import *
import time 
...
parser.add_argument('--model_path', default='/home/panpeng/fmy/save_model/base_ye/Dy_no_HU_nohup/', type=str, help='model save path')
...
def extract_query_feat(query_loader):
    ...
    print('Extracting Time:\t {:.3f}'.format(time.time()-start))
    print('Extracting Time:\t {:.3f}'.format(time.time() - start), file=test_log_file)
    return query_feat,query_att_s3,query_label
...
query_cam6_0027_0018 = query_att_s3[237:238,:,:,:]
query_label_now = query_label[237]
print(query_label_now)
view_query_s3_hu = torch_vis_color('sysu_dy_nohu_cam6_0027_0018',query_cam6_0027_0018,32,32,'/DATA/fengmengya/save_image/LWPA_DY_noHU/',colormode=2,margining=1)  
all_cmc = 0
all_mAP = 0 
all_cmc_pool = 0
if dataset =='regdb':
