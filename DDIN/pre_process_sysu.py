...
np.save(data_path + 'HEloss/train_rgb_resized_img.npy', train_img)
np.save(data_path + 'HEloss/train_rgb_resized_label.npy', train_label)

# ir imges
train_img, train_label = read_imgs(files_ir)
np.save(data_path + 'HEloss/train_ir_resized_img.npy', train_img)
np.save(data_path + 'HEloss/train_ir_resized_label.npy', train_label)
