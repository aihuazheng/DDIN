...
class FeatureVisualizer:
    ...
    def __init__(self, upsample_size=(418, 126), cmap_type='jet', reduce_type='mean', upsample_type='bilinear'):
    ...
    def __transform_feature(self, f):
        ...
        print("f",f.shape)  #1,1,256,128
        print("f", f.squeeze().shape)  # 1,1,256,128
    ...
    def save_both(self, f, save_path, recover=False, show=False):
        fig = plt.figure()
