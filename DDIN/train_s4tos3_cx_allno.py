...
from model_s4tos3_cx_allno import embed_net
from utils import *
...
parser.add_argument('--model_path', default='/DATA/fengmengya/save_model/Dynamic_s4tos3_cx_allno/', type=str, 
