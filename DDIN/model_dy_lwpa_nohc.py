...
class embed_net(nn.Module):
    ...
    def forward(self, x1, x2, modal = 0 ):
        ...
        if self.training:
            return (out_0, out_1, out_2, out_3, out_4, out_5,out_layer_att,out_s3), (self.l2norm(y_0), self.l2norm(y_1), self.l2norm(y_2), self.l2norm(y_3), self.l2norm(y_4), self.l2norm(y_5),self.l2norm(y_feat),self.l2norm(y_layer_att),self.l2norm(y_s3)),r_s3_hu.i_s3_hu
        else:
            x_0 = self.l2norm(x_0)
            x_1 = self.l2norm(x_1)
            x_2 = self.l2norm(x_2)
