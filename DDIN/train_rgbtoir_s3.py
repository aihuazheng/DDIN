...
from model_rgbtoir_s3 import embed_net
from utils import *
...
parser.add_argument('--model_path', default='/DATA/fengmengya/save_model/Dynamic_s3_RGBtoIR', type=str, 
